      ...
      <div class="container">
        <div class="row">
            ...
            <div class="reservation-left-side">
              <div class="form-horizontal">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-12">
                    <a href="/owner/reservations/edit/${reservation.id}" class="btn btn-primary pull-right">Edytuj</a>
                  </div>
          ...
          <div class="col-md-3 reservation-right-side visible-lg">
            ...
            <img src="data:image/jpeg;base64,${reservation.restaurant.logoBase64}" alt="Logo" style="width: 300px; height: 150px;" />
