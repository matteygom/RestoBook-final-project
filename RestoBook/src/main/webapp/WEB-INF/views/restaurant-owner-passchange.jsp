                        ...
                        <div class="GridLex-col-3_sm-4_xs-12">
                            ...
                            <div class="admin-sidebar">
                                ...
                                <div class="admin-user-item">
                                    ...
                                    <p class="user-role">${user.get().role}</p>

                                </div>

                                <div class="admin-user-action text-center">

                                    <a href="/owner/dashboard/restaurantEdit/${user.get().id}" class="btn btn-primary btn-sm">Edytuj</a>
                        ...
                        <div class="GridLex-col-9_sm-8_xs-12">
                            ...
                            <div class="admin-content-wrapper">
                                ...
                                <div class="admin-section-title">
                                    ...
                                    <h2>Zmiana hasła</h2>
                                    <p>Warto zmieniać hasło od czasu do czasu. Zrób to tutaj</p>

                                </div>

                                <form class="post-form-wrapper" method="post" action="${pageContext.request.contextPath}/owner/passwordchange/${userId}">
