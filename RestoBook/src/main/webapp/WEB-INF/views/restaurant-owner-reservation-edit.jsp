      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-9">
            <div class="reservation-left-side">
              <div class="form-horizontal">
                  ...
                  <form:form role="form" modelAttribute="reservation" class="form-horizontal">
                  <div class="form-group">
                    <!-- Full Name -->
                    <label class="col-sm-3 control-label">Pełne imię i nazwisko&nbsp;*</label>
                    <div class="col-sm-9">
                      <form:input path="title" type="text" placeholder="Tytuł" class="form-control custom-title"/>
                      <form:input path="fullName" type="text" placeholder="Pełne imię i nazwisko" class="form-control custom-name" id="name"/>
                    </div>
                  </div>
                  <!-- Full Name end -->
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <form:input path="email" type="email" placeholder="Adres Email" class="form-control"/>
                    </div>
                  </div>
                  <!-- Email Address end -->
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <form:input path="phoneNumber" type="text" placeholder="Numer Tel/Kom" id="tel_no" class="form-control"/>
                    </div>
                  </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="input-group">
                            <form:input path="date" type="date" class="form-control" id="reachus-date" placeholder="Data"/>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <form:input path="guestsCount" type="number" placeholder="Liczba Gości" id="no_of_guest" class="form-control" min="0"/>
                    </div>
                  </div>
                  <!-- No. of Guest end -->
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <form:textarea path="specialRequest" placeholder="Życzenia specjalne" rows="3" style="resize: none;" id="special_request" class="form-control"/>
                    </div>
                  </div>
                  <!-- Special Guest end -->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-12">
                    <a href="/owner/reservations/list/${reservation.restaurant.id}" class="btn btn-secondary pull-right" style="background-color: #66afe9">Wróć</a>
                  </div>
          ...
          <div class="col-md-3 reservation-right-side visible-lg">
            ...
            <img src="data:image/jpeg;base64,${reservation.restaurant.logoBase64}" alt="image" style="width: 300px; height: 200px;"/>
